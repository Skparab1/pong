...
while True:
    try:
        ...
        if lost == 1:
            print('you have lost')
            break
        linein = 1 if ('o' in line1 ) else (1 if ('o' in line2 ) else (2 if ('o' in line3 ) else (3 if ('o' in line4 ) else (4 if ('o' in line5 ) else (5 if ('o' in line6 ) else (6 if ('o' in line7 ) else (7 if ('o' in line8 ) else (8 if ('o' in line9 ) else 9 if ('o' in line10 ) else (10 if ('o' in line11 ) else (11 if ('o' in line12 ) else (12 if ('o' in line13 ) else (13 if ('o' in line14 ) else (14 if ('o' in line15 ) else (15 if ('o' in line16 ) else (16 if ('o' in line17 ) else 17)))))))))))))))
        padstorer = padpos
        padpos = round(padpos)
        if pos <= 20 and (movedirection == 'left' or movedirection == 'leftup' or movedirection == 'leftdown'):
            if spos > linein:
                spos -= 1
            if (linein - spos) > 1:
                spos += 1   
