...
# to add a mid line to each line being printed
def addmidline(line):
    global midlinealt
...
# remove the ball from all lines using .replace
...
# adding the ball to a position on a line
...
# moving the ball in a direction by redefining each line using removeball and addball
